...
c     TUTO_OSU initialize 3vec for mom and inv mass
      double precision pinv(0:3), invm
...
c     sqrt(s) cuts defined by TUTO_OSU
      invm=0d0
      do i=0,3
         pinv(i)=0d0
      enddo
      ...
      invm=dsqrt(pinv(0)**2-pinv(1)**2-pinv(2)**2-pinv(3)**2)
      if (invm.lt.950d0) then
         passcuts=.false.
         return
      endif
